...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
	<head>
		...
		<title>Thông báo đăng ký ứng dụng thành công</title>
	...
	*/
		#templateHeader{
			/*@editable*/background-color:#00add8;
            ...
            <td valign="top" class="mcnTextBlockInner" style="padding-top:9px;">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px;color: #FFFFFF;font-family: Arial, &quot;Helvetica Neue&quot;, Helvetica, sans-serif;font-size: 30px;line-height: 200%;text-align: center;">
                        
                            <span style="font-family:arial,helvetica neue,helvetica,sans-serif"><strong>ỨNG DỤNG CHẤM CÔNG</strong></span>
                        </td>
                    </tr>
                </tbody></table>
				<!--[if mso]>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <p>Chào mừng bạn đã đăng ký ứng dụng chấm công của công ty. Bộ phận quản lý sẽ kiểm tra và sớm kích hoạt tài khoản cho bạn.</p>
                    ...
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Helvetica; font-size: 18px; padding: 18px;">
                                <a class="mcnButton " title="Điều chỉnh thông tin đăng ký" href="http://" target="_self" style="font-weight: bold;letter-spacing: -0.5px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Điều chỉnh thông tin đăng ký</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
                    ...
                    <tbody><tr>
                        ...
                        <td style="padding-top:9px; padding-left:18px; padding-bottom:9px; padding-right:18px;">
                            ...
                            <table border="0" cellspacing="0" class="mcnTextContentContainer" width="100%" style="min-width: 100% !important;background-color: #F7F7F7;">
                                <tbody><tr>
                                    <td valign="top" class="mcnTextContent" style="padding: 18px;color: #808080;font-family: Helvetica;font-size: 16px;line-height: 200%;text-align: center;">
                                        <h3>Hướng dẫn sử dụng</h3>
Bạn có thể tham khảo hướng dẫn sử dụng <a href="http://" target="_blank">tại đây</a>
                                    </td>
                                </tr>
                            </tbody></table>
                        </td>
            ...
            <td valign="top" class="mcnTextBlockInner" style="padding-top:9px;">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px;color: #0C0C0C;">
                        
                            <em>Copyright © 2018 Thegioisua, All rights reserved.</em>
                        </td>
                    </tr>
                </tbody></table>
				<!--[if mso]>
