...
@endsection
@section('title')
    <h1 class="title_master_form">KHO HÀNG</h1>
@endsection
                        ...
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <th class="text" style="width:15%;">Địa chỉ kho </th>
                                    <th class="text" style="width:10%;">Tên Kho</th>
                                    <th class="text" style="width:10%" >Ngày Tạo</th>
                                    <th class="text" style="width:10%" >Ngày cập nhật</th>
                                    <th class="text" style="width:10%" >Ngày thanh tra</th>
                                    ...
                                    <th class="text" style="width:10%;">Loại Kho</th>
